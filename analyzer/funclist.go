...
var functions = map[typeutil.FuncName]funcType{ //nolint:gochecknoglobals
	...
	{Path: "github.com/stretchr/testify/assert", Receiver: "Assertions", Name: "ErrorIs", Ptr: true}:      funcErr0,
	{Path: "github.com/stretchr/testify/assert", Receiver: "Assertions", Name: "ErrorIsf", Ptr: true}:     funcErr0,
	{Path: "github.com/stretchr/testify/assert", Receiver: "Assertions", Name: "NotErrorIs", Ptr: true}:   funcErr0,
	{Path: "github.com/stretchr/testify/assert", Receiver: "Assertions", Name: "NotErrorIsf", Ptr: true}:  funcErr0,
	{Path: "github.com/stretchr/testify/require", Receiver: "Assertions", Name: "ErrorIs", Ptr: true}:     funcErr0,
	{Path: "github.com/stretchr/testify/require", Receiver: "Assertions", Name: "ErrorIsf", Ptr: true}:    funcErr0,
	{Path: "github.com/stretchr/testify/require", Receiver: "Assertions", Name: "NotErrorIs", Ptr: true}:  funcErr0,
	{Path: "github.com/stretchr/testify/require", Receiver: "Assertions", Name: "NotErrorIsf", Ptr: true}: funcErr0,
}
