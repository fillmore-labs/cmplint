...
func init() { golangci.Plugin("cmplint", New) }
...
// Plugin is the cmplint linter as a [golangci.LinterPlugin].
type Plugin struct {
	settings Settings
}
...
// BuildAnalyzers returns the [analysis.Analyzer]s for a cmplint run.
