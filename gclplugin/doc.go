...
/*
Package gclplugin provides golangci-lint plugin integration for the [cmplint] analyzer.
	...
	linters:
	  ...
	  settings:
	    custom:
	      cmplint:
	        type: module
	        description: cmplint detects comparisons against the address of newly created values.
	        original-url: https://fillmore-labs.com/cmplint

4. Run the linter:

	./golangci-lint run .

[cmplint]: https://github.com/fillmore-labs/cmplint#cmplint
*/
package gclplugin
